...
import com.cynergy.Srikanth.model.messageSchema;
...
public class webSocketcontroller {
    ...
    public messageSchema register(@Payload messageSchema schema,SimpMessageHeaderAccessor headerAccessor){ 
/*
...
*/
    ...
    @SendTo("/channel/public") // Used to Specify the queue
    public messageSchema sendmessage(@Payload messageSchema Schema){
        return Schema;
